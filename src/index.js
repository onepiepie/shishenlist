...
class Story extends React.Component {
  ...
  componentDidMount() {
    axios.get("https://yys.clmystes.tech/api/get_hero_story?heroid=" + this.props.heroid).then((response) => {
      this.setState({
        story: response.data
      })
    }).catch((error) => {
...
class Attr extends React.Component {
  ...
  componentDidMount() {
    axios.get("https://yys.clmystes.tech/api/get_hero_attr?heroid="+ this.props.heroid+"&awake=0&level=1&star=2").then((response) => {
      this.setState({
    ...
    if (this.props.level !== "SP"){
      axios.get("https://yys.clmystes.tech/api/get_hero_attr?heroid="+ this.props.heroid+"&awake=1&level=1&star=2").then((response) => {
        this.setState({
...
class TopBar extends React.Component {
  ...
  componentDidMount() {
    ...
    /** 调用api接口获取数据 */
    axios.get("https://yys.clmystes.tech/api02/pc/zt/20161108171335/js/app/all_shishen.json?v69").then((response) => {
      this.setState({
